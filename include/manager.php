...
<div ng-controller="headerController">
  ...
  <div class="sidebar">
    <ul class="nav">
      <li class="<?php if($params['page'] == 'recipt') { echo 'active'; }?>"><a uib-tooltip="Recipt Generator" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/recipt"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/014-group.svg" alt="" /> <span class="nav-menu-text">Recipt Generator</span></a></li>
      <li class="<?php if($params['page'] == 'supplier') { echo 'active'; }?>"><a uib-tooltip="Suppliers" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/suppliers"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/014-group.svg" alt="" /> <span class="nav-menu-text">Suppliers</span></a></li>
      ...
      <li class="<?php if($params['page'] == 'publisher') { echo 'active'; }?>"><a uib-tooltip="Publisher" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/publisher"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/017-list.svg" alt="" /> <span class="nav-menu-text">Publisher</span></a></li>
      ...
      <li class="<?php if($params['page'] == 'barcode') { echo 'active'; }?>"><a uib-tooltip="Barcode for Print" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/barcode"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/018-application.svg" alt="" /> <span class="nav-menu-text">Barcode</span></a></li>
