...
<div ng-controller="headerController">
  ...
  <div class="sidebar">
    <ul class="nav">
      ...
      <li class="<?php if($params['page'] == 'assign') { echo 'active'; }?>"><a uib-tooltip="Assign Publishers to Products at Once" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/product"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/product.svg" alt="" /> <span class="nav-menu-text">Assign Publishers</span></a></li>
