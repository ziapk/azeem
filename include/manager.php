...
<div ng-controller="headerController">
  ...
  <div class="sidebar">
    <ul class="nav">
      <li class="<?php if($params['page'] == 'product') { echo 'active'; }?>"><a uib-tooltip="Add New Product" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/product/create.php"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/product.svg" alt="" /> <span class="nav-menu-text">New Product</span></a></li>
      ...
      <li class="<?php if($params['page'] == 'dup') { echo 'active'; }?>"><a uib-tooltip="Duplicate Items" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/product/duplicates.php"><span class="fa fa-copy text-danger"></span> <span class="nav-menu-text">Duplidate Items</span></a></li>
