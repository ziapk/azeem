...
<div ng-controller="headerController">
  <nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
      ...
      <ul class="list-inline navbar-right navbar-nav nav">
        ...
        <!-- <li><a style="padding-left: 8px; padding-right: 8px" uib-tooltip="Sale Return" tooltip-placement="bottom" title=""  href="<?php echo SITE_URL.'pages/supply';?>"><small><small class="nav-menu-text text-small">Sale Return</small></small></a></li>
        <li><a style="padding-left: 8px; padding-right: 8px" uib-tooltip="Purchase Return" tooltip-placement="bottom" title=""  href="<?php echo SITE_URL.'pages/supply';?>"><small><small class="nav-menu-text text-small">Purchase Return</small></small></a></li> -->
        ...
        <li><a style="padding-left: 8px; padding-right: 8px" uib-tooltip="Demands" tooltip-placement="bottom" title="" href="<?php echo SITE_URL; ?>pages/demand"><small><small class="nav-menu-text text-small">Invoicing</small></small></a></li>
  ...
  <div class="sidebar">
    <ul class="nav">
      ...
      <li class="<?php if($params['page'] == 'demand') { echo 'active'; }?>"><a uib-tooltip="Demands" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/demand"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/justice-hammer.svg" alt="" /> <span class="nav-menu-text">Invoicing</span></a></li>
