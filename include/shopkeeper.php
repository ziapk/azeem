...
<div ng-controller="headerController">
  ...
  <div class="sidebar">
    <ul class="nav">
      ...
      <li class="<?php if($params['page'] == 'recipt') { echo 'active'; }?>"><a uib-tooltip="Recipt Generator" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/recipt" target="_blank"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/receipt.svg" alt="" /> <span class="nav-menu-text">Recipt Generator</span></a></li>
      ...
      <li class="<?php if($params['page'] == 'demand') { echo 'active'; }?>"><a uib-tooltip="Demands" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/demand" target="_blank"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/justice-hammer.svg" alt="" /> <span class="nav-menu-text">Demands</span></a></li>
      <li class="<?php if($params['page'] == 'barcode') { echo 'active'; }?>"><a uib-tooltip="Barcode for Print" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/barcode" target="_blank"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/qrcode.svg" alt="" /> <span class="nav-menu-text">Barcode</span></a></li>
    </ul>
