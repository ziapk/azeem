  ...
  if (empty($params['hideSidebar'])) { ?>
    <div class="sidebar" ng-class="{'showSidebar': showSidebar}">
      <ul class="nav">
        ...
        <li class="<?php if ($params['page'] == 'least') { echo 'active'; } ?>"><a uib-tooltip="Least Products" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/product/least.php"><img class="fa" width="20" height="20" src="<?php echo SITE_URL; ?>assets/img/svg/product.svg" alt="" /> <span class="nav-menu-text">Min Products</span></a></li>
