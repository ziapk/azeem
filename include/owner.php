  ...
  <nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
      ...
      <ul class="list-inline navbar-right navbar-nav nav">
        <li class="<?php if($params['page'] == 'supply') { echo 'active'; }?>"><a uib-tooltip="Add Supply" tooltip-placement="right" title=""  href="<?php echo SITE_URL.'pages/supply';?>" class="btn btn-primary btn-xs pull-right">Purchases</a></li>
        <li class="<?php if($params['page'] == 'demand') { echo 'active'; }?>"><a uib-tooltip="Demands" tooltip-placement="right" title="" href="<?php echo SITE_URL; ?>pages/demand"><small><small class="nav-menu-text text-small">Invoicing</small></small></a></li>
