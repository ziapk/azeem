...
$demands = $doubleEntryObj->getJournals(['from' => $startDate, 'to' => $endDate, 'type' => ["DIRECT_PAYMENT", "DIRECT_RECEIVING", "ADJUSTMENT"]], $ids);
$acd_ids = [];
$grouping = [];
...
echo mainHeader(['page' => 'ledger-transactions']);
