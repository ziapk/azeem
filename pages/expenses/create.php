...
<div class="container">
    ...
    <form method="POST" action="" autocomplete="off">
        ...
        <div class="row">
            <p>
                <label>Title</label>
                <input type="text" name="title" placeholder="Example: Bill, Salary" class="form-control">
            </p>
            <p>
            ...
            <p>
                ...
                <textarea name="description" placeholder="Example: Bill, Salary" class="form-control"></textarea>
            </p>
