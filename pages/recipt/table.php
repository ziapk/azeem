...
<script type="text/ng-template" id="row.html">
    <a style="display: flex; align-items: center">
        ...
        <span ng-if="match.model.wh_price" class="label" style="font-size: 14px">{{match.model.wh_price}}</span><span ng-if="match.model.wh_price">|</span><?php if ($userData['role'] === 'owner') { ?><span ng-if="match.model.pprice" class="label" style="font-size: 14px">{{match.model.pprice}}</span><span ng-if="match.model.pprice">|</span><?php } ?><span ng-if="match.model.pack_size" class="label label-primary" style="font-size: 14px">{{match.model.pack_size}}B</span><span ng-if="match.model.pack_size">|</span><?php if ($userData['role'] === 'owner') { ?><span class="label label-success" style="margin-left: auto; font-size: 14px">{{match.model.qty}}</span> | <?php } ?><span class="label label-danger" style="font-size: 14px">{{match.model.price}}</span>
    </a>
</script>
