    ...
    <table id="resultTable" width="100%" style="border-collapse: collapse" border="0">
        ...
        <tfoot>
            <tr>
                ...
                <th style="border: 1px solid" align="right"><?php echo number_format($rows['totals']['debit']); ?></th>
                <th style="border: 1px solid" align="right"><?php echo number_format($rows['totals']['credit']); ?></th>
            </tr>
        </tfoot>
    </table>
<?php }
