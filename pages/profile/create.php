        ...
        <form class="form-vertical" ng-submit="updateProfile()">
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="control-label" style="font-size: 0.7em; font-weight: bold; letter-spacing: 1px">Role</label>
                    ...
                    <div class="form-group">
                        <label class="control-label" style="font-size: 0.7em; font-weight: bold; letter-spacing: 1px">Shop</label>
