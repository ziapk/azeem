...
<script type="text/ng-template" id="addSupplier.html">
    <form ng-submit="ok()"> 
        <div class="modal-header">
            <h3 class="modal-title" id="modal-title">Add Author</h3>
        </div>
        <div class="modal-body" id="modal-body">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input id="scontact" type="text" ng-model="form.contact" class="form-control" placeholder="Contact">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input id="scompany" type="text" ng-model="form.company" class="form-control" placeholder="company">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="saddress" type="text" ng-model="form.address" class="form-control" placeholder="Address">
            </div>
